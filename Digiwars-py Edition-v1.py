...
Deck1=['Militia','Mage','Dragonic Roamers','Sunbeam Serpents','Copperskin Ranger']
...
Deck3=['Rain of frogs','Griffin','Kurestral Knight','Xuri']
Deck_dmg={'Militia':1,'Mage':2,'Swordsman':3,'Cavalier':5,'Kurestral Majin':4,'Griffin':6,'Kurestral Knight':7,'Dragonic Roamers':2,
          'Sunbeam Serpents':1,'Basilisk':3,'Trandoshan':3,'Broodmother Qordia':4,'Lucid Matriarchs':4,'Xuri':8,'Copperskin Ranger':2,
          'Amberhides':3,'Heliotrooper':4,'Harpies of the hunt':5,'Blood Ministers':4,'Brood Sages':5,'Klaxi':5,'Rain of frogs':4}
...
p1hand.append(r)
r=Deck3[random.randint(0,len(Deck3)-1)]
p1hand.append(r)
...
p2hand.append(r2)
r2=Deck3[random.randint(0,len(Deck3)-1)]
p2hand.append(r2)
...
while True:
    ...
    if p1hp<=0:
        ...
        arena.hideturtle()
        pen.goto(0,0)
        pen.write("Player 2 has won the match!!",align="center", font=("Courier",40, "normal"))
        chance=3
    if p2hp<=0:
        pen.clear()
        score1.clear()
        ...
        arena.hideturtle()
        pen.goto(0, 0)
        pen.write("Player 1 has won the match!!",align="center", font=("Courier",40, "normal"))
        chance=3
